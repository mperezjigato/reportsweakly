...
Efforts have focused on running both *LAMMPS* for a small (ethanol box) test case [^1] and the *atomic simulation environment* (ASE) for MD water box relaxation [^2]. 
