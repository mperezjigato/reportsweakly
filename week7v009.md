...
Since most cases are large systems, all the XSF/CIF/PDB geometries derived from LAMMPS provided examples have crashed so far on a local laptop (DSI's guest2).
